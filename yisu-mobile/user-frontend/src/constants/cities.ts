...
// 国内城市
export const DOMESTIC_CITIES: Record<string, string[]> = {
  热门: ['北京', '上海', '广州', '深圳', '成都', '杭州', '西安', '重庆', '南京', '武汉'],
  A: ['阿坝', '阿拉善', '阿里', '安康', '安庆', '鞍山', '安顺', '安阳'],

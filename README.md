...
#### 1. 克隆项目
```bash
git clone https://github.com/yourusername/yisu-hotel.git
cd yisu-hotel
```

#### 2. 数据库配置
```sql
CREATE DATABASE yisu_hotel CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE yisu_hotel;
